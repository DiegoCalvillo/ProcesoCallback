...
<script type="text/javascript">
	...
	{
		if(dato == "Si"){
			location = "http://10.100.40.2:3000/IR"
		}
		else if(dato == "No"){
...
<div id="page-content-wrapper">
	<div class="container-fluid">
		...
		<div class="col-lg-12" style="display: none; margin-left: 80px;" id="PS3">
			<font color="#FF5733">
				<p><b>Si.</b> <em>Esperar respuesta del usuario</em></p>
		...
		<div class="col-lg-12" style="display: none; margin-left: 130px;" id="PAS3">
			<font color="#FF5733">
				<p><b>Si:</b> Sr. (Srita) <em>(Mencionar Nombre del usuario)</em>, le contacto para informarle que: <em>(Explicar respuesta del Folio)</em></p>
		...
		<div class="col-lg-12" style="display: none; margin-left: 180px;" id="P1AS3">
			<font color="#FF5733">
				<p><b>Si:</b><em> Resuelve la duda o incoveniente del usuario</em></p>
				<b>¿Se resolvió?</b>
		...
		<div class="col-lg-12" style="display: none;" id="P1AN3">
		...
		<div class="col-lg-6" style="display: none; margin-left: 230px;" id="P2AS3">
			<font color="#FF5733">
				<p><b>Si.</b>De acuerdo <em>(Mencionar Nombre del usuario)</em>, entonces como acordamos, yo le estaría marcando cuando tenga respuesta de su folio, de mi parte sería todo, muchas gracias por su tiempo y que tenga buen día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-12" style="display: none; margin-left: 230px;" id="P2AN3">
			<font color="#FF5733">
				<p><b>No.</b><em> Pide apoyo al supervisor e intenta resolver el incoveniente del usuario.</em></p>
		...
		<div class="col-lg-6" style="display: none; margin-left: 280px;" id="P3AS3">
			<font color="#FF5733">
				<b>Si.</b><p>De acuerdo <em>(Mencionar el nombre del usuario)</em> entonces como acordamos, yo le estaría marcando cuando tenga respuesta de su folio, de mi parte sería todo, muchas gracias por su tiempo y que tenga buen día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-12" style="display: none; margin-left: 280px;" id="P3AN3">
			<font color="#FF5733">
				<b>No.</b><p><em>Escala la llamada al Supervisor.</em></p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<!--Negativa de la pregunta 3-->	
			<div class="col-lg-6" style="display: none; margin-left: 80px;" id="PN3">
				<font color="#FF5733">
					<p><b>No.</b> <em>Esperar respuesta del usuario</em></p>
		...
		<div class="col-lg-6" style="display: none; margin-left: 130px;" id="P3SB">
			<font color="#FF5733">
				<b>Proporciona día y hora:</b><p>Muy bien, entonces yo me estaría comunicando con Usted <em>(repetir el tiempo y hora)</em>. Le agradezco haberme dado un poco de su tiempo Sr. (Srta)<em>(Mencionar Nombre del usuario)</em>, le recuerdo mi nombre <em>(menciona tu nombre)</em> del Departamento de Calidad de Telcel, que tenga un excelente día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-6" style="display: none; margin-left: 130px;" id="P3NB">
			<font color="#FF5733">
				<b>Se rehusa tomar la llamdada:</b><p>En ese caso no le molesto más, le agradezco haberme dado un poco de su tiempo Sr. (Srta) <em>(Mencionar Nombre del usuario)</em>, le recuerdo mi nombre <em>(menciona tu nombre)</em> del Departamento de Calidad de Telcel, que tenga un excelente día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-12" style="display: none; margin-left: 80px;" id="PS4">
			<font color="#FF5733">
				<p><b>Si.</b> Mucho gusto, le llamo en atención a la llamada que Usted hizo al *111 el <em>(Especificar Fecha de llamada)</em>, me percaté que no quedó satisfech@ con el servicio que le proporcionamos y me gustaría platicar con usted al respecto. ¿Es este un buen momento para tomar mi llamada?</p>
		...
		<div class="col-lg-12" style="display: none; margin-left: 180px;" id="P1AS4">
			<font color="#FF5733">
				<p><b>Si:</b> Sr. (Srta)<em>(Mencionar Nombre de Usuario)</em>, le contacto para informarle que <em>(Explicar respuesta del folio)</em>.</p>
			</font>
		</div>
		...
		<div class="col-lg-6" style="display: none; margin-left: 280px;" id="P3AS4">
			<font color="#FF5733">
				<b>Si:</b><p>De acuerdo <em>(Mencionar Nombre de usuario)</em>, entonces como acordamos, yo le estaría marcando cuando tenga respuesta de su folio, de mi parte sería todo, muchas gracias por su tiempo y que tenga buen día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-12" style="display: none; margin-left: 330px;" id="P4AS4">
			<font color="#FF5733">
				<p><b>Si:</b> De acuerdo <em>(Mencionar el nombre del usuario)</em>, entonces como acordamos, yo le estaría marcando cuando tenga respuesta de su folio, de mi parte sería todo,</p><p> muchas gracias por su tiempo y que tenga un buen día.</p> 
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-12" style="display: none; margin-left: 330px;" id="P4AN4">
			<font color="#FF5733">
				<b>No:</b><em>Escala la llamada al Supervisor.</em>
			</font>
		</div>
		...
		<div class="col-lg-12" style="display: none; margin-left: 230px;" id="P2AN4">
			<font color="#FF5733">
				<b>No:</b><em>Cierra la llamada.</em>
			</font>
		</div>
		<!--FIN Negativa de la segunda pregunta alterna de la pregunta 4-->
		...
		<div class="col-lg-12" style="display: none; margin-left: 130px;" id="PAN4">
			<font color="#FF5733">
				<p><b>No:</b><em> Esperar respuesta del usuario.</em>
		...
		<div class="col-lg-6" style="display: none; margin-left: 180px;" id="P4NB">
			<font color="#FF5733">
				<b>Se rehusa a tomar la llamada:</b><p>En ese caso no le molesto más, le agradezco haber dado un poco de su tiempo Sr. (Srta) <em>(mencionar el nombre del usuario)</em>, le recuerdo mi nombre <em>(menciona tu nombre)</em>del Departamento de Calidad de Telcel, que tenga un excelente día.</p>
			<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<!--Pregunta 5-->
			<div class="col-lg-12" style="display: none;" id="P5">
				<font color="#1F618D">
					<p>5.- Hola <em>(buenos días, buenas tardes, buenas noches)</em>. Mi nombre es: <em>(menciona tu nombre)</em> del departamento de Calidad de Telcel, ¿tengo el gusto con el Sr. (Srita.) <em>(menciona el nombre del usuario)?</em> </p>
					<p><em>Esperar respuesta del usuario.</em></p>
		...
		<div class="col-lg-12" style="display: none; margin-left: 80px;" id="PAS6">
			<font color="#FF5733">
				<b>Si:</b><p><em> Iniciar con la solución de la llamada</em></p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-6" style="display: none; margin-left: 130px;" id="P1AS6">
			<font color="#FF5733">
				<b>Proporciona dia y hora:</b><p>Muy bien, entonces yo me estaría comunicando con Usted <em>(repetir el tiempo y hora)</em>, le agradezco haberme dado un poco de su tiempo Sr. (Srta)<em>(Mencionar el nombre del Usuario)</em>, le recuerdo mi nombre <em>(menciona tu nombre)</em> del Departamento de Calidad de Telcel, que tenga un excelente día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>	
			</font>
		</div>
		...
		<div class="col-lg-6" style="display: none; margin-left: 80px;" id="PAS7">
			<font color="#FF5733">
				<p><b>Si:</b> Muy bien, mire le llamo en relación a la llamada que Usted hizo al *111 el <em>(Especificar fecha de llamada)</em>, me percaté que no quedó muy satisfech@ con el servicio que le proporcionamos y me gustaría platicar con usted al respecto. ¿Con quien tengo el gusto?</p>
		...
		<div class="col-lg-12" style="display: none; margin-left: 230px;" id="P3AN7">
			<font color="#FF5733">
				<p><b>No:</b><em> Escala la llamada al supervisor</em></p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-6" style="display: none; margin-left: 180px;" id="P5AN7">
			<font color="#FF5733">
				<b>Se rehusa a tomar la llamada:</b><p> En ese caso no le molesto más, le agradezco haber dado un poco de su tiempo Sr. (Srta) <em>(Mencionar nombre del usuario)</em>, le recuerdo mi nombre <em>(menciona tu nombre)</em> del Departamento de Calidad de Telcel, que tenga un excelente día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-12" style="display: none; margin-left: 80px;" id="PAN7">
			<font color="#FF5733">
				<p><b>No:</b> ¿Cuando podría localizar <em>(Mencionar nombre de usuario)</em>?</p>
				<em>(Esperar respuesta del usuario)</em>
		...
		<div class="col-lg-6" style="display: none; margin-left: 130px;" id="P4AS7">
			<font color="#FF5733">
				<b>Proporciona día y hora: </b><p>Muy bien, entonces yo me estaría comunicando <em>(repetir el tiempo y hora)</em>, le agradezco haberme dado un poco de su tiempo, le recuerdo mi nombre <em>(menciona tu nombre)</em> del Departamento de Calidad de Telcel, que tenga un excelente día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
		...
		<div class="col-lg-6" style="display: none; margin-left: 130px;" id="P4AN7">
			<font color="#FF5733">
				<b>Se rehusa dar información: </b><p>En ese caso le agradezco haberme dado un poco de su tiempo le recuerdo mi nombre <em>(menciona tu nombre)</em> del Departamento de Calidad de Telcel, que tenga un excelente día.</p>
				<a href="/categorias" class="btn btn-default">Guardar y elegir la categoría</a>
			</font>
		</div>
